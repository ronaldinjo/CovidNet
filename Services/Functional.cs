        ...
        public async Task InitAppData()
        {
            try
            {
                ...
                List<State> state= new List<State>() {
                    new State{StateName = "Macedonia"},
                    new State{StateName = "Kosovo"},
                    new State{StateName = "Albania"},
                    new State{StateName = "UK"},
                    new State{StateName = "Germany"},
                    new State{StateName = "Italy"}
                   

                };
                await _context.State.AddRangeAsync(state);
                await _context.SaveChangesAsync();
            

                List<Patient> patient = new List<Patient>() {
                    new Patient{PatientName = "Lirim", isCorona= true , StateId =1 },
                    new Patient{PatientName = "Rusetm", isCorona= true , StateId =1},
                    new Patient{PatientName = "Shaqipe", isCorona= true , StateId =3},
                    new Patient{PatientName = "Toni", isCorona= true , StateId =2},
                    new Patient{PatientName = "Albin", isCorona= true , StateId =1},
                    new Patient{PatientName = "Shpres",  isCorona= true , StateId =1},
                    new Patient{PatientName = "Linda", isCorona= true , StateId =2},
                    new Patient{PatientName = "Lidije",  isCorona= true , StateId =1},
                  
                };
                await _context.Patient.AddRangeAsync(patient);
                await _context.SaveChangesAsync();
